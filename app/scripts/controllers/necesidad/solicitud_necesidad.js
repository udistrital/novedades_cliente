...
.controller('SolicitudNecesidadCtrl', function(administrativaRequest, $scope, agoraRequest, oikosRequest, coreRequest, financieraRequest) {
  ...
  self.validar_infoGeneral = function() {
    var faltanCampos = true;

    if ($scope.info_general) {
      var datosPorValidar = [self.necesidad.TipoNecesidad, self.necesidad.PlanAnualAdquisiciones,
        self.necesidad.UnidadEjecutora, self.necesidad.EstudioMercado,
        self.necesidad.AnalisisRiesgo, self.necesidad.ModalidadSeleccion];
    ...
    function abrirParteForm(parteAbrir) {
