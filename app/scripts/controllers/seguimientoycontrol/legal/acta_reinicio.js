...
angular.module('contractualClienteApp')
    .controller('SeguimientoycontrolLegalActaReinicioCtrl', function ($location, $scope, $routeParams, token_service, $translate, adminMidRequest, contratoRequest, agoraRequest, coreAmazonRequest, novedadesMidRequest, novedadesRequest) {
        this.awesomeThings = [
            'HTML5 Boilerplate',
            'AngularJS',
            'Karma'
        ...
        agoraRequest.get('estado_contrato?query=NombreEstado:En ejecucion').then(function (ec_response) {
        ...
        self.generarActa = function () {
            ...
            if ($scope.formReinicio.$valid) {
                novedadesRequest.get('tipo_novedad', 'query=Nombre:Reinicio').then(function (nc_response) {
                    ...
                    self.contrato_estado.NumeroContrato = self.contrato_obj.numero_contrato;
                ...
                agoraRequest.get('contrato_estado?query=NumeroContrato:' + self.contrato_obj.id + ',Vigencia:' + self.contrato_obj.vigencia + '&sortby=Id&order=desc&limit=1').then(function (ce_response) {
                    if (ce_response.data[ce_response.data.length - 1].Estado.NombreEstado == "Suspendido") {
                                    ...
                                    agoraRequest.post('contrato_estado', nuevoEstado).then(function (response) {
                                        if (response.status == 201 || Object.keys(response.data) > 0) {
                                            ...
                                            swal(
                                                ...
                                                $translate.instant('DESCRIPCION_REINICIO') + self.contrato_obj.numero_contrato + ' ' + $translate.instant('ANIO') + ': ' + self.contrato_obj.vigencia,
                                                'success'
                                            ).then(function () {
                            ...
                            table: {
                                ...
                                body: [
                                    [
                                        ...
                                        { text: 'ACTA DE REINICIO', bold: true, alignment: 'center', fontSize: 9 },
                ...
                content: [
                    {
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    { text: 'DÍAS DE SUSPENSIÓN', bold: true, style: 'topHeader' },
                                    { text: self.reinicio_nov.periodosuspension, style: 'topHeader' }
                                ],
                                [
                                ...
                                [
                                    ...
                                    { text: self.format_date_letter_mongo(self.reinicio_nov.fechareinicio), style: 'topHeader' }
                                ]
                    ...
                    },
                    {
                        ...
                        text: [
                            '\n\n',
                            'Entre los suscritos, a saber ' + self.contrato_obj.supervisor_nombre_completo + ' identificado con  ' + self.contrato_obj.supervisor_tipo_documento + ' No. ' + self.contrato_obj.supervisor_cedula + ' de ' + self.contrato_obj.supervisor_ciudad_documento + ' en su calidad de supervisor y ' + self.contrato_obj.contratista_nombre + ' identificado con ' + self.contrato_obj.contratista_tipo_documento + ' No. ' + self.contrato_obj.contratista_documento + ' de ' + self.contrato_obj.contratista_ciudad_documento +
                            ' en su calidad de contratista, se ha determinado REINICIAR el contrato de ' + self.contrato_obj.tipo_contrato + ' No. ' + self.contrato_id + ' de ' + self.contrato_vigencia +
                            ', suspendido durante el periodo comprendido entre el día ' + self.format_date_letter_mongo(self.reinicio_nov.fechasuspension) + ' y ' + self.format_date_letter_mongo(self.f_finsuspension), '.\n\n',
                        ]
                    },
                    {
                        style: ['general_font'],
                        text: [
                            'MOTIVO DE LA SUSPENSIÓN: ' + self.reinicio_nov.motivo + '.\n\n' +
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    ...
                                    { text: 'CC. ' + self.contrato_obj.supervisor_cedula, bold: false, style: 'topHeader' }
                                ],
                                [
                                    { text: 'Contratista', bold: true, style: 'topHeader' },
                                    { text: self.contrato_obj.supervisor_rol, bold: true, style: 'topHeader' }
                                ],
                                [
