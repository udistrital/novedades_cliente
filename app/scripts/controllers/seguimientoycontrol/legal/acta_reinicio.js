                            ...
                            table: {
                                ...
                                body: [
                                    [
                                        ...
                                        { text: 'ACTA DE REINICIO', bold: true, alignment: 'center', fontSize: 12 },
                ...
                content: [
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    ...
                                    { text: parseInt(self.contrato_obj.plazo) + parseInt(self.reinicio_nov.periodosuspension), style: 'topHeader' }
                                ],
                                [
                                    { text: 'FECHA DE INICIO', bold: true, style: 'topHeader' },
                                    { text: self.format_date(self.reinicio_nov.fechasuspension), style: 'topHeader' }
                                ],
                                [
                                    { text: 'FECHA SUSPENSIÓN', bold: true, style: 'topHeader' },
                                    { text: self.reinicio_nov.periodosuspension + ' día(s)', style: 'topHeader' }
                                ],
                                [
                                    { text: 'FECHA DE REINICIO', bold: true, style: 'topHeader' },
                                    { text: self.format_date(self.reinicio_nov.fechareinicio), style: 'topHeader' }
                                ]
                    ...
                    },
                    {
                        ...
                        text: [
                            ...
                            ', suspendido durante el periodo comprendido entre el día ' + self.format_date_letter_mongo(self.reinicio_nov.fechasuspension) + ' y ' + self.format_date_letter_mongo(self.reinicio_nov.fechareinicio), '.\n\n',
                    ...
                    },
                    {
                        ...
                        text: [
                            ...
                            { text: 'Inteventor y/o Supervisor' }
                        ]
                    },
                    {
                        style: ['general_font'],
                    ...
                    },
                    {
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    { text: 'Elaboro:', style: 'topHeader', alignment: 'left' },
                                    { text: 'Aprobó: ', style: 'topHeader', alignment: 'left' },
                                ],
                                [
                                    { text: '\n\n__________________________', style: 'topHeader', alignment: 'left' },
                                    { text: '\n\n__________________________', style: 'topHeader', alignment: 'left' }
                                ],
                                [
                                    '',
                                    { text: self.contrato_obj.jefe_juridica_nombre_completo, style: 'topHeader', alignment: 'left' },
                                ],
                                [
                                    '',
                                    { text: ' CC: ' + self.contrato_obj.jefe_juridica_documento, style: 'topHeader', alignment: 'left' },
                                ],
                                [
                                    '',
                                    { text: 'Jefe Oficina Asesora Jurídica ', style: 'topHeader', alignment: 'left' },
                                ],
