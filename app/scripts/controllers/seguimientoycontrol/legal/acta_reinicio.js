...
angular.module('contractualClienteApp')
    .controller('SeguimientoycontrolLegalActaReinicioCtrl', function ($location, $scope, $routeParams, token_service, $translate, adminMidRequest, contratoRequest, amazonAdministrativaRequest, coreAmazonRequest, novedadesMidRequest, novedadesRequest) {
        this.awesomeThings = [
            'HTML5 Boilerplate',
            'AngularJS',
            'Karma'
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                /* [
                                    ...
                                    { text: parseInt(self.contrato_obj.plazo) + ' meses Y ' + self.reinicio_nov.periodosuspension+' días.', style: 'topHeader' }
                                ],*/
                                [
...

                    {
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    { text: 'Contratista', bold: true, style: 'topHeader' },
                                    { text: self.contrato_obj.supervisor_cargo, bold: true, style: 'topHeader' }
                                ],
                                [
