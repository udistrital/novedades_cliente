    ...
    self.get_pdf = function(){
        return {
          ...
          },
            {
                ...
                ' en su calidad de interventor y/o supervisor y ' + self.contrato_obj.contratista_nombre + ' identificado con ' + self.contrato_obj.contratista_tipo_documento + ' No. ' + self.contrato_obj.contratista_documento + ' de ' + self.contrato_obj.contratista_ciudad_documento + 
