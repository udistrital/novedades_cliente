...
angular.module('contractualClienteApp')
    .controller('SeguimientoycontrolLegalActaCesionCtrl', function ($translate, $location, $scope, $routeParams, token_service, coreAmazonRequest, amazonAdministrativaRequest, contratoRequest, novedadesMidRequest, novedadesRequest) {
        ...
        contratoRequest.get('contrato', self.contrato_id + '/' + self.contrato_vigencia).then(function (wso_response) {
            ...
            self.contrato_obj.supervisor_cedula = wso_response.data.contrato.supervisor.documento_identificacion; novedadesRequest
        ...
        self.generarActa = function () {
            ...
            self.contrato_obj.plazo_cesionario = (f_terminacion_contrato.diff(f_inicio_contrato, 'days')) - (f_cesion.diff(f_inicio_contrato, 'days'))
                            ...
                            table: {
                                ...
                                body: [
                                    [
                                        ...
                                        { text: 'ACTA DE CESIÓN', bold: true, alignment: 'center', fontSize: 9 },
                ...
                content: [
                            ...
                            [
                                ...
                                { text: 'Que mediante oficio No. ' + self.num_oficio + ' de fecha ' + self.format_date_letter_mongo(self.f_oficio) + ', el supervisor del ' + self.contrato_obj.tipo_contrato + ' No. ' + self.contrato_obj.id + ' de ' + self.contrato_obj.vigencia + ', le comunicó al señor (a) ' + self.contrato_obj.ordenador_gasto_nombre + ' en calidad de Ordenador el Gasto del citado contrato, la autorización para ceder el mismo, a partir del día ' + self.format_date_letter_mongo(self.f_cesion) + ', y aportó un estado financiero expedido por la Sección de Presupuesto, en donde informa lo siguiente:' },
                                {
                                    ul: [
                                        ...
                                        'Existe un valor pendiente por cancelar al señor ' + self.contrato_obj.contratista_nombre + ', por valor de ' + NumeroALetras(self.valor_a_favor + '') + '($' + numberFormat(self.valor_a_favor + '') + '), que corresponden al periodo comprendido entre el día ' + self.format_date_letter_mongo(self.contrato_obj.Inicio) + ' al dia ' + self.format_date_letter_mongo(self.f_terminacion) + '.\n',
                                        'La suma a ceder al señor (a) ' + self.cesionario_obj.nombre + ' ' + self.cesionario_obj.apellidos + ' es de ' + NumeroALetras(self.valor_contrato_cesionario() + '') + '($' + numberFormat(self.valor_contrato_cesionario() + '') + '), por un plazo de ' + self.contrato_obj.plazo_cesionario + ' días.',
                                    ]
                                },
                                '\n'
                            ],
                    ...
                    },
                    {
                        ...
                        text: [
                            ...
                            [
                                {
                                    text: 'CLAUSULA TERCERA: PUBLICACIÓN. ', bold: true,
                                },
                                {
...

                    {
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    { text: 'Ordenador de Gasto', bold: true, style: 'topHeader' },
                                ...
                                [
                                    { text: 'CC. ' + self.cesionario_obj.identificacion, bold: false, style: 'topHeader' },
                                    { text: '', bold: false, style: 'topHeader' }
                                ],
                                [
                                    { text: 'Cesionario', bold: true, style: 'topHeader' },
