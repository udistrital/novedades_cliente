...
angular.module('contractualClienteApp')
    .controller('SeguimientoycontrolLegalActaCesionCtrl', function ($translate, $location, $scope, $routeParams, coreAmazonRequest, amazonAdministrativaRequest, contratoRequest, novedadesMidRequest, novedadesRequest) {
