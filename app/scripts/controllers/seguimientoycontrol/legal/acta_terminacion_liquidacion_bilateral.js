        ...
        contratoRequest.get('contrato', self.contrato_id + '/' + self.contrato_vigencia).then(function (wso_response) {
            ...
            amazonAdministrativaRequest.get('tipo_contrato?query=Id:' + wso_response.data.contrato.tipo_contrato).then(function (tc_response) {
                ...
                amazonAdministrativaRequest.get('acta_inicio?limit=-1&query=NumeroContrato:' + self.contrato_obj.NumeroContrato).then(function (acta_response) {
                    ...
                    if (fechas_acta != null) {
                        self.contrato_obj.FechaInicio = fechas_acta[0].FechaInicio;
                    }
                    else {
                ...
                // TO DO: Haceer una prueba de un contrato con cesión, se debe terminar.
                            ...
                            table: {
                                ...
                                body: [
                                    [
                                        ...
                                        { text: 'ACTA DE TERMINACIÓN Y LIQUIDACIÓN BILATERAL', bold: true, alignment: 'center', fontSize: 12 },
                ...
                content: [
                        ...
                        text: [
                            {
                                text: [
                                    {
                                        text: '\n\nEntre los suscritos a saber, ' + self.contrato_obj.supervisor_nombre_completo + ', mayor de edad, de la ciudad'+
                                        self.contrato_obj.supervisor_ciudad_documento +', identificado con ' + self.contrato_obj.supervisor_tipo_documento + ' No. ' +
                                            self.contrato_obj.supervisor_cedula + ' de ' + self.contrato_obj.supervisor_ciudad_documento + ' en calidad de ' + self.contrato_obj.supervisor_rol + ' y por la otra, ' + self.contrato_obj.contratista_nombre +
                                            ', mayor de edad, e identificado(a) con ' + self.contrato_obj.contratista_tipo_documento + ' No. ' + self.contrato_obj.contratista_documento + ' de ' + self.contrato_obj.contratista_ciudad_documento + ' quíén actúa en calidad de contratista, hemos convenido en'
                                    },
                                    { text: ' TERMINAR ANTICIPADAMENTE Y POR MUTUO ACUERDO ', bold: true },
                                    { text: ' y en consecuencia liquidar a partir de la firma de la presente acta, el ' + self.contrato_obj.tipo_contrato + ' No. ' + self.contrato_id + ' de ' + self.contrato_vigencia + ' suscrito el día ' + self.format_date_letter(self.contrato_obj.FechaSuscripcion) + '.' }
                                ]
                            },
                            {
                    ...
                    },
                    {
                        ...
                        ol: [
                            ...
                            'Que la Orden se perfeccionó y ejecutó mediante Registro Presupuestal No. __________' + '.\n\n',
                            ...
                            'Que mediante oficio ' + numberFormat(self.terminacion_nov.numerooficioestadocuentas + '') + ' el Supervisor y/o el Ordenador del Gasto de el ' + self.contrato_obj.tipo_contrato + ', solicitan al Jefe de la Sección de Presupuesto de la Universidad Distrital, la elaboración del estado de cuenta de la referida Orden.\n\n',
                            ...
                            'Que el valor del  ' + self.contrato_obj.tipo_contrato + ' se pactó en la suma total de ' + NumeroALetras(self.contrato_obj.valor) + '($' + numberFormat(self.contrato_obj.valor) + ")" + '.\n\n',

                            'Que según certificación de fecha _____________ de ________ de  _______, expedida por Jefe de Sección de Presupuesto, presenta un saldo a la fecha de  __________________________________________________________________________________($_________________).\n\n',
                        ...
                        text: [
                            {
                                text: [
                                    ...
                                    { text: ' Teniendo en cuenta que el Contratista, ejecutó los servicios hasta el dia ' + self.format_date_letter_mongo(self.terminacion_nov.fecha_terminacion_anticipada) + ', y no existe ningún saldo a favor de éste. \n\n' }
                                ]
                    ...
                    },
                    {
                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    { text: 'CC. ' + self.contrato_obj.supervisor_documento, bold: false, style: 'topHeader' },
                    ...
                    },
                    {
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    { text: 'Elaboro : ', bold: false, style: 'topHeader' },
                                ...
                                [
                                    { text: 'Revisó : ', bold: false, style: 'topHeader' },
                                ...
                                [
                                    { text: '' },
                                    { text: self.contrato_obj.jefe_juridica_nombre_completo, bold: false, style: 'topHeader' },
                                    ' ',
                                    ' '
                                ],
                                [
                                    ...
                                    { text: '' },
                                    { text: 'CC. ' + self.contrato_obj.jefe_juridica_documento, bold: false, style: 'topHeader' },
                                    ' ',
                                    ' '
                                ],
                                [
