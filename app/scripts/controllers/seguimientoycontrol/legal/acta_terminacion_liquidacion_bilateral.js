    ...
    self.get_plantilla = function(){
        return {
                     ...
                     text:[
                           {
                                ...
                                text: [
                                         {text: '\n\nEntre los suscritos a saber, ' + self.contrato_obj.supervisor_nombre_completo + ', mayor de edad, vecino de esta ciudad, identificado con ' + self.contrato_obj.supervisor_tipo_documento  + ' No. ' + 
                                         self.contrato_obj.supervisor_cedula + ' Expedida en '+ self.contrato_obj.supervisor_ciudad_documento + ' en calidad de ' + self.contrato_obj.supervisor_rol +  ' y por la otra, ' + self.contrato_obj.contratista_nombre +
                                         ', mayor de edad, identificado(a) con ' + self.contrato_obj.contratista_tipo_documento +  ' No. ' +  self.contrato_obj.contratista_documento + ' Expedida en ' + self.contrato_obj.contratista_ciudad_documento + ' quíén actúa en calidad de contratista.'  +
                                         ' hemos convenido en'},         
            ...
            },
            {
                ...
                'Que según certificación de fecha _____________ de ________ de  _______, expedida por Jefe de Sección de Presupuesto, presenta un saldo a la fecha de  ________________________________________________________________________________________($_________________).\n\n',
