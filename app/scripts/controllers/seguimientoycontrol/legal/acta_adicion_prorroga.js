              ...
              html:
                ...
                '<style>' +
                  ...
                  '#progress-bar {' +
                    ...
                    'animation:progress-indeterminate 2.5s infinite linear, gradient-shift 5s infinite ease-in-out;' +
                    'box-shadow:0 2px 8px rgba(0,0,0,0.15), inset 0 1px 2px rgba(255,255,255,0.6);' +
                  '}' +
                '</style>',
