...
angular.module('contractualClienteApp')
    .controller('SeguimientoycontrolLegalActaAdicionProrrogaCtrl', function ($scope, $routeParams, coreAmazonRequest, contratoRequest, $translate, argoNosqlRequest, amazonAdministrativaRequest, novedadesRequest, novedadesMidRequest) {
        ...
        contratoRequest.get('contrato', +self.contrato_id + '/' + self.contrato_vigencia).then(function (wso_response) {
            ...
            amazonAdministrativaRequest.get('informacion_persona_natural?query=Id:' + self.contrato_obj.supervisor_cedula).then(function (ipn_response) {
                ...
                novedadesMidRequest.post('novedad', self.data_acta_adicion_prorroga).then(function(request){
                    if (request.status == 200) {
                        ...
                        swal({
                            ...
                            type: 'success',
                            html: $translate.instant($scope.alert) + self.contrato_obj.id + $translate.instant('ANIO') + self.contrato_obj.VigenciaContrato+'.',
                ...
                content: [
                    {
                        ...
                        columns: [
                            {
                                text: 'Adición: _____________\n\n', bold: true, alignment: 'center'
                            },
                            {
                                text: 'Prórroga: _____________\n\n', bold: true, alignment: 'center'
                            }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        ...
                        text: 'a.  Información General\n\n', bold: true, alignment: 'center', style: 'topHeader'
                    },
                    {
                        style: ['firstTable'],
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    ...
                                    { text: self.contrato_obj.ObjetoContrato, style: 'topHeader' }
                                ],
                                [
                                    { text: 'LOCALIZAIÓN DEL PROYECTO', bold: true, style: 'topHeader' },
                                    { text: '', style: 'topHeader' }
                                ],
                                [
                                    { text: 'PLAZO INICIAL', bold: true, style: 'topHeader' },
                                    { text: self.contrato_obj.PlazoEjecucion, style: 'topHeader' }
                                ],
                                [
                                    { text: 'VIGENCIA', bold: true, style: 'topHeader' },
                                    { text: self.contrato_obj.VigenciaContrato, style: 'topHeader' }
                                ],
                                [
                                    { text: 'FECHA DE INICIACIÓN', bold: true, style: 'topHeader' },
                                    { text: self.contrato_obj.FechaRegistro, style: 'topHeader' }
                                ],
                                [
                                    { text: 'VALOR INCIAL DEL CONTRATO', bold: true, style: 'topHeader' },
                                    { text: $scope.valor_contrato_letras + ' MONEDA CORRIENTE ($' + numberFormat(self.contrato_obj.ValorContrato) + ' M/Cte.)', style: 'topHeader' }
                                ],
                                [
                                    { text: 'CONTRATISTA', bold: true, style: 'topHeader' },
                                    { text: self.contrato_obj.contratista_nombre + ", mayor de edad, identificado(a) con cedula de ciudadanía No. " + self.contrato_obj.contratista_documento + " Expedida en ___________________________________", style: 'topHeader' }
                                ],
                                [
                                    { text: 'SUPERVISOR', bold: true, style: 'topHeader' },
                                    { text: self.contrato_obj.supervisor_nombre + ", mayor de edad, identificado(a) con cedula de ciudadanía No. " + self.contrato_obj.supervisor_cedula + " Expedida en ___________________________________", style: 'topHeader' }
                                ]
                            ]
                        },
                        layout: {
                    ...
                    },
                    {
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    { text: 'Contrato adicional No.', bold: true, style: 'topHeader' },
                                    { text: 'Tiempo (mes/días calendario)', bold: true, style: 'topHeader' }
                                ],
                                [
                                    { text: '\n\n', style: 'topHeader' },
                                    { text: '\n\n', style: 'topHeader' }
                    ...
                    {
                        style: ['general_font'],
                        text: '\n\nc.  Suspensión y ampliaciones de suspensión\n\n', bold: true, alignment: 'center'
                    },
                    {
                        style: ['firstTable'],
                        table: {
                    ...
                    {
                        style: ['general_font'],
                        text: '\n\ne. Condiciones Actuales del Contrato\n\n', bold: true, alignment: 'center'
                    },
                    {
                        style: ['firstTable'],
                        table: {
                    ...
                    [
                        ...
                        {
                            text: 'Hasta el ________________ () día del mes _______ del año __________, el proyecto presentaba un avance físico ejecutado del ____% contra un avance físico programado del _____%.'
                        },
                    ],
                    ...
                    {
                        text: 'Hasta el ________________ () día del mes _______ del año __________, el proyecto presentaba un valor ejecutado del $ __________________________  que corresponde _______% con respecto al valor del contrato.'
                    },
                    {
                    ...
                    },
                    {
                        ...
                        ol: [
                            [
                                { text: 'Causales de adición', bold: true },
                                { text: 'El (Contratista o Consultor), a través de la comunicación radicada en la interventoría y a laUniversidad Distrital bajo el No. ___________________ de ______________________ solicita una adición para la terminación del contrato de por __________________________________________________ argumentando, que (señalar los argumentos principales para la adición): \n' },
                                { text: $scope.motivo + '\n\n' }
                            ],
                            [
                                { text: 'Recursos a Suprimir correspondiente a las actividades que no se van a ejecutar', bold: true },
                                { text: 'En el Cuadro No. , en este cuadro se presentan los ítems y las cantidades originales del contrato a suprimir&gt; se relacionan los recursos a suprimir que corresponden principalmente a: ________________________________________________________________________________________________________.\n El valor de los recursos a suprimir asciende a la suma de $_____________________________ \n\n' }
                            ],
                            [
                                { text: 'Recursos para obras adicionales', bold: true },
                                { text: 'En el Cuadro No. ________________________; se relacionan los recursos adicionales que corresponden principalmente a:\n ____________________________________________________________________________________________________________; El valor los recursos adicionales asciende a la suma de $ ______________________________ \n\n' }
                            ],
                            [
                                { text: 'Recursos para items no previstos', bold: true },
                                { text: 'En el Cuadro No_________________________;se relacionan los recursos para actividades no previstas que corresponden principalmente a: ____________________________________________________________________________________________________________________________________; El valor de los recursos de items no previstos, asciende a la suma de $________________________________\n Los items de actividades no previstas se soportan con el acta No. ____________________________ de fijación de precios no previstos.\n\n' }
                            ],
                            [
                                { text: 'Valor de la adición', bold: true },
                                [
                                    { text: '5.1 De los valores totales de los cuadros se obtiene el valor total de la adición\n\n' },
                                    {
                                        type: 'lower-alpha',
                                        ol: [
                                            'Valor recursos del contrato:$ _______________',
                                            'Valor recursos suprimidos : $ _______________',
                                            'Valor recursos adicionales : $ _______________',
                                            'Valor recursos extras : $ _______________',
                                            'Valor adicion (c+d-b) : $ _______________',
                                            'Nuevo valor del contrato : $ ______________'
                                        ]
                                    },
                                    { text: '\n\n5.2 Valor de la adición en S.M.M.L.V.\n\n' },
                                    {
                                        type: 'lower-alpha',
                                        ol: [
                                            'Valor recursos del contrato:$ _______________',
                                ...
                                { text: '\n\nNota: El S.M.M.L.V. para el cálculo de la presente adición es ____________________________\n\n' }
                            ],
                        ]

                    },
                    {
                        text: '\n\ni.  Solicitud de prórroga\n\n', alignment: 'center'
                    },
                    {
                        text: 'El ( Contratista o Consultor), a través de la comunicación radicada en la interventoría y a la Universidad Distrital bajo el No. _____________________ de _________________________; solicita una ampliación de plazo para la terminación del contrato de ____________________________; por _________________ días calendario, argumentando, que (señalar los argumentos principales para la prorroga): \n _________________________________________________________________________'
                    },
                    {
                        text: '\n\nk.  SSolicitud de aprobación\n\n', alignment: 'center'
                    },
                    {
                        text: 'El (Contratista o Consultor) anexa a esta solicitud de modificación del contrato de ________________________, No. ________ la certificación de pago de aportes de             empleados del contrato, expedida por el revisor fiscal o representante legal del contratista, como también copia de la relación de pago de obligaciones parafiscales. \n                Para constancia de lo anterior, se firma en original y tres (3) copias la presente acta bajo la responsabilidad expresa de los que intervienen en ella, a los días ____ del mes _________ del __________.'
                    },
                    {
                        style: ['table2'],
                        table: {
                            ...
                            body: [
                                [
                                    { text: '\n\n______________________________________', bold: false, style: 'topHeader' },
                                    { text: '\n\n______________________________________', bold: false, style: 'topHeader' }
                                ],
                                [
                                    { text: 'Contratista', bold: true, style: 'topHeader' },
                                    { text: 'Interventor', bold: true, style: 'topHeader' }
                                ],
                                [
                                    { text: '\n\n______________________________________', bold: false, style: 'topHeader' },
                                    { text: '' }
