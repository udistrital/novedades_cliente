    ...
    self.formato_pdf = function(){
        return {
                    ...
                    table: {
                        ...
                        body: [
                            ...
                            [ 
                                ...
                                {text: '____________________________________',  style: 'topHeader'}                                     
                            ],
                            [ 
            ...
            {         
                ...
                {text: 'acordamos [prorrogar el plazo y adicionar  el valor] del '+self.contrato_obj.tipo_contrato+' No. '+self.contrato_id+' de '+self.fecha_reg_ano+', teniendo en cuenta los siguientes documentos y consideraciones: ' },
                {text: '1) ', bold:true},
                ...
                {text: 'que justifica de la siguiente manera: “…”. '},
                {text: '6) ', bold:true},
                ...
                {text: ''+self.contrato_obj.tipo_contrato+' No. '+self.contrato_id+'de '+self.fecha_reg_ano+', presenta para firma conjunta del Rector de LA UNIVERSIDAD '},
                {text: 'y del representante legal de EL CONTRATISTA, tal solicitud con el siguiente fundamento: “…”. '},
                {text: '7) ', bold:true},
                ...
                {text: '8) ', bold:true},
                {text: 'Que mediante oficio No. XXXX de XXXX con cordis 201XIEXXX de la misma fecha, '},
                {text: 'el Rector de '},
                {text: 'LA UNIVERSIDAD, ', bold:true},
            ...
            {         
                ...
                {text: 'como se desprende del Certificado de Disponibilidad Presupuestal No. XXXX de XXXX, '},
            ...
            {         
                ...
                table: {           
                    ...
                    body:[             
                        [               
                            {text:[
                                    {text: 'CARLOS JAVIER MOSQUERA SUAREZ\n', bold: true},
                                    {text: 'Rector (E)\n'},
                                    {text: 'La Universidad'}
                                  ]
                            },
                            {text:[
                                    {text: ''+self.contrato_obj.OrdenadorGasto+'\n', bold: true},
            ...
            {         
                ...
                table: {           
                    ...
                    body:[             
                        ...
                        [ 
                        {text: 'Proyectado'},
                        {text: 'Diana Paola Gutiérrez  Preciado, Abogada Contratista – OAS'},   
                        ' ',
                        ' '        
                        ],   
                        [ 
                        {text: 'Revisado y Aprobado'},
                        {text: 'Carlos Arturo Quintana Astro, Jefe OAS'},         
                        ' ',
                        ' ' 
                        ],          
                    ]         
