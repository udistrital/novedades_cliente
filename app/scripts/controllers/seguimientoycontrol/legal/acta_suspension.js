                ...
                return {
                    ...
                    },
                    {
                        ...
                        text: [
                            ...
                            " de " +
                            self.contrato_obj.contratista_ciudad_documento +
                            " en su calidad de contratista, hemos determinado SUSPENDER el " +
                            self.contrato_obj.tipo_contrato +
                            " No. " +
                            self.contrato_id +
                            " de " +
                        ...
                        },
                        {
                            ...
                            text: [{
                                text: [
                                    ...
                                    { text: ' el contrato de prestación de servicios No. ' + self.contrato_id + ', a partir del '+self.format_date_letter_mongo(self.terminacion_nov.fechasolicitud)+'\n\n' }
                                ]
