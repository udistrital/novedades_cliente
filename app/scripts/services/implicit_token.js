        ...
        function ($q, CONF, md5, $interval, autenticacionMidRequest) {
            var service = {
              ...
              Documento: appUserInfo.documento
                            ...
                            autenticacionMidRequest
                                ...
                                .then(function (respuestaAutenticacion) {
                                    ...
                                    window.localStorage.setItem(
                                        "access_code",
                                        btoa(JSON.stringify(appUserDocument))
                                    );
                                    window.localStorage.setItem(
                                        "access_role",
                                        btoa(JSON.stringify(appUserRole))
                                    );
                                    //
                ...
                getHeader: function () {
                    var payload = service.getAppPayload();
                    service.setting_bearer = {
                        headers: {
                            Accept: "application/json",
                            Authorization: "Bearer " + window.localStorage.getItem("access_token"),
                            "Content-Type": "application/json",
                             "X-User": payload.appUserDocument
                        },
                    };
