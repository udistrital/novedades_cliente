 ...
 */
angular.module('cumplidosMidService', [])
    .factory('cumplidosMidRequest', function ($http, $q, requestRequest, token_service, CONF) {
        // Service logic
        // ...
        var path = CONF.GENERAL.CUMPLIDOS_MID_SERVICE;
